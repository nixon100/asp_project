  ...
  return (
    <div>
      ...
      <div className="app2">
        ...
        <Testing data2={data2} setData2={setData2} dropdown={"mercedes"} />
      </div>
 ...
 */}
      ...
      <div className="App">
        <button id="xyz" onClick={downloadExcel1}>
          Download Excel Template
        </button>
        <button id="xyz" onClick={downloadExcel2}>
          Download Reference Name
        </button>
        <button id="xyz" onClick={downloadExcel}>
          Download as Excel
        </button>
      </div>
