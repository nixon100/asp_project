...
const perfinder6 =(i,j,paymentRealized,Q)=>{
     ...
     for (let i =0; i< animals.length;i++){
      ...
      const s =Math.round(newton(paymentRealized,i,commision,j,closingfees))
      console.log("newton",s)
      Result.push(s);
      }else if (props.dropdown==="saab"){
        const s =Math.round(newton(paymentRealized,i,commision,j,closingfees1))
        console.log("newton",s)
      Result.push(s);
      }else if (props.dropdown==="mercedes") {
        const s =Math.round(newton(paymentRealized,i,commision,j,closingfees2))
        console.log("newton",s)
      Result.push(s);
      }
