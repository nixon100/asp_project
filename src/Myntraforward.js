...
const level = [];
  ...
  const handleFormSubmit = (e) => {
    ...
    for (let i=0; i<commision["Sheet1"].length; i++){
      if ((formData.dataB === commision["Sheet1"][i]["Brand"])&&(formData.dataC ===commision["Sheet1"][i]["Article_Type"]) && (formData.dataG === commision["Sheet1"][i]["Gender"])){
  ...
  const fixedFeesfind = ()=>{
    return (formData.ASP>1500)?43:(formData.ASP>1000)?42:(formData.ASP>750)?19:(formData.ASP>500)?15:7
  ...
  const reversechargesGett = () =>{
    ...
    return (reversechargesget*(formData.data2/100)/(1-(formData.data2/100)))
  }
      ...
      <div className="gamut-14z39fp-LayoutGrid 14g39">
        ...
        <div className="form-example1">
          ...
          <input
            ...
            onChange={(e) => {
              setFormData({ ...formData, data0: parseInt(e.target.value), zlc: false });
              handleClick(e);
...
<p>Selling Price: {formData.ASP}</p>
          ...
          <input
            ...
            value={formData.ASP}
            onChange={(e) => {
             setFormData({ ...formData, ASP: parseInt(e.target.value),xcv:false })
      ...
      <div className="form-example">
        ...
        <div className="form-example">
          ...
          <select
            ...
            onChange={(e) => setFormData({ ...formData, dataB: e.target.value })}
          >
            <option value="">--Please choose an option--</option>
            <option value="DressBerry">DressBerry</option>
            <option value="House of Pataudi">House of Pataudi</option>
            <option value="Ode by House of Pataudi">Ode by House of Pataudi</option>
        ...
        <div className="form-example">
          ...
          <select
            ...
            onChange={(e) => setFormData({ ...formData, dataG: e.target.value })}
          >
            <option value="">--Please choose an option--</option>
            
            {(formData.dataB === "DressBerry") ? 
            <option value="Women">Women</option> : null
          }
        ...
        <div className="form-example">
          ...
          <select
            ...
            onChange={(e) => setFormData({ ...formData, dataC: e.target.value })}
          >
            <option value="">--Please choose an option--</option>
            {(formData.dataB === "DressBerry") ? 
        ...
        <div className="form-example">
          ...
          <input
            ...
            id="0011"
            value={pv}
            onChange={(e) => setFormData({ ...formData, dataPV: e.target.value })}
            required
          />
