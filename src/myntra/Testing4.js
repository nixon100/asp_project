...
const Testing4 = (props) => {
    ...
    function packages(i,j,paymentRealized,Q){
        // //console.log("j", j)
         const maximumval = Commision.Sheet1[0].Commission
...
function newton (payment,i,commision,j){
    function calculateResult(B4, B5, B6, B7) {
        ...
        const B8 = (B4 > 1500 ? 43 : B4 > 1000 ? 42 : B4 > 750 ? 19 : B4 > 500 ? 15 : 7);
        console.log("b8",B8)
        ...
        const BB10 = () => {
            if (storage.Level === 1){
              const as = Forward.Sheet1[0].__EMPTY_2
              return (as / (1 - B7));
            } else if (storage.Level === 2) {
              const as = Forward.Sheet1[1].__EMPTY_2
              return as / (1 - B7);
            } else if (storage.Level === 3){
              const as = Forward.Sheet1[2].__EMPTY_2
              return as / (1 - B7);
            } else if (storage.Level === 4){
              const as = Forward.Sheet1[3].__EMPTY_2
              return as / (1 - B7);
            } else if (storage.Level === 5){
              const as = Forward.Sheet1[4].__EMPTY_2
              return as / (1 - B7);
            }
          }
          const B10 =BB10()
      ...
      const BB11 =() => {
        if (storage.Level === 1){
        const as = reverse.Sheet1[0].__EMPTY_2
        return as * B7 / (1 - B7);
        }else if (storage.Level === 2) {
            const as = reverse.Sheet1[1].__EMPTY_2
        return as * B7 / (1 - B7);
        }else if (storage.Level === 3){
            const as = reverse.Sheet1[2].__EMPTY_2
        return as * B7 / (1 - B7);
        }else if (storage.Level === 4){
            const as = reverse.Sheet1[3].__EMPTY_2
        return as * B7 / (1 - B7);
        }else if (storage.Level === 5){
            const as = reverse.Sheet1[4].__EMPTY_2
        return as * B7 / (1 - B7);
      }
    }
    const B11 =BB11();
    ...
    const goalSeekResult = newtonRaphson(B5, B5 * initialGuess, B7, initialGuess, tolerance, targetResult);
    return goalSeekResult
    // Printing the result
